  ...
  return (
    <>
      <div className="group flex flex-col">
        {/* Image */}
        <div
          className="relative overflow-hidden bg-stone-100 aspect-[4/5] cursor-pointer"
        ...
        <div className="mt-4 flex flex-col gap-3">
          <div>
            <h3
              className="text-base font-medium text-stone-800 cursor-pointer hover:text-stone-500 transition-colors"
              onClick={() => setOpen(true)}
            >
              {product.name}
            </h3>
